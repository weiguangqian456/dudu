...
public class ArmsUtils {
    ...
    public static int findImageByName(Context context, String imageName) {
        int resId = getResources(context).getIdentifier(imageName, "mipmap", context.getPackageName());
        return resId;
    }
    ...
    public static <T extends View> T findViewByName(Activity activity, String viewName) {
        int id = getResources(activity).getIdentifier(viewName, "id", activity.getPackageName());
...
//    }
    ...
    public static void startActivity(Context activity, Class homeActivityClass) {
        Intent intent = new Intent(activity.getApplicationContext(), homeActivityClass);
        activity.startActivity(intent);
    }
    ...
    public static void startActivityForResult(Activity context, Class clazz, Bundle params, int requestCode) {
        Intent intent = new Intent(context, clazz);
        intent.putExtras(params);
    ...
    public static String formatting(double content) {
        return formatting(2, content);
    }

    public static String formatting(int scale, double content) {
        DecimalFormat df = new DecimalFormat("#0." + scaleStr(scale));
        return df.format(content);
    }

    public static String formatting(int content) {
        return formatting(2, content);
    }

    public static String formatting(int scale, int content) {
        DecimalFormat df = new DecimalFormat("#0." + scaleStr(scale));
        return df.format(content);
    }

    public static String formatting(String content) {
        return formatting(2, content);
    }

    public static String formatting(int scale, String content) {
        DecimalFormat df = new DecimalFormat("#0." + scaleStr(scale));
        double doubleStr = 0;
        try {
            doubleStr = Double.parseDouble(content);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static String scaleStr(int scale) {
        String scaleStr = "";
