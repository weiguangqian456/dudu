...
/**
 * @author Created by EDZ on 2019/1/8.
 *         Describe
 */
...
//            });
        ...
        if (!TextUtils.isEmpty(imageUrl)) {
            Glide.with(context).load(imageUrl).apply(RequestOptions.placeholderOf(com.hyphenate.helpdesk.R.drawable.hd_default_image).diskCacheStrategy(DiskCacheStrategy.ALL))
                    .into(mImageView);
