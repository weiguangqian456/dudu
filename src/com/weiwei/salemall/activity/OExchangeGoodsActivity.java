 ...
 *         兑换专区商品
 */
public class OExchangeGoodsActivity extends TempAppCompatActivity implements View.OnClickListener {
...
//                    mDataList.add(allBean);
    ...
    private void initViewPager() {
        ...
        for (int i = 0; i < (mDataList.size() == 0 ? 0 : 1); i++) {
            ...
            Fragment exChangeFragment = NewExchangeFragment.newInstance(bundle);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.et_input:
                ...
                String[] value = new String[]{"2", columnId, "y"};
