 ...
 * item页底部的推荐商品适配器
 */
public class ItemRecommendAdapter implements Holder<List<RecommendGoodsEntity>> {
    ...
    @Override
    public void UpdateUI(final Context context, int position, final List<RecommendGoodsEntity> data) {
