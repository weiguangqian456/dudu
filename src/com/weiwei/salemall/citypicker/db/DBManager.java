package com.weiwei.salemall.citypicker.db;
...
import static com.weiwei.salemall.citypicker.db.DBConfig.COLUMN_C_CODE;
import static com.weiwei.salemall.citypicker.db.DBConfig.COLUMN_C_NAME;
import static com.weiwei.salemall.citypicker.db.DBConfig.COLUMN_C_PINYIN;
import static com.weiwei.salemall.citypicker.db.DBConfig.COLUMN_C_PROVINCE;
import static com.weiwei.salemall.citypicker.db.DBConfig.DB_NAME_V1;
import static com.weiwei.salemall.citypicker.db.DBConfig.LATEST_DB_NAME;
import static com.weiwei.salemall.citypicker.db.DBConfig.TABLE_NAME;
...
public class DBManager {
    ...
    public DBManager(Context context) {
        ...
        DB_PATH = File.separator + "data" + Environment.getDataDirectory().getAbsolutePath() + File.separator + context.getPackageName() + File.separator + "databases" + File
                .separator;
        copyDBFile();
    }
    ...
    public List<City> searchCity(final String keyword) {
        String sql = "select * from " + TABLE_NAME + " where " + COLUMN_C_NAME + " like ? " + "or " + COLUMN_C_PINYIN + " like ? ";
        SQLiteDatabase db = SQLiteDatabase.openOrCreateDatabase(DB_PATH + LATEST_DB_NAME, null);
