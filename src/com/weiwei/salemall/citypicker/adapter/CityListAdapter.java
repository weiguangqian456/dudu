...
import com.weiwei.salemall.citypicker.adapter.decoration.GridItemDecoration;
...
public class CityListAdapter extends RecyclerView.Adapter<CityListAdapter.BaseViewHolder> {
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        ...
        if (holder instanceof LocationViewHolder) {
            ...
            int space = mContext.getResources().getDimensionPixelSize(R.dimen.w_16_dip);
            ...
            switch (locateState) {
                case LocateState.LOCATING:
                    ((LocationViewHolder) holder).current.setText("正在定位...");
                    break;
                case LocateState.SUCCESS:
                    ((LocationViewHolder) holder).current.setText(data.getName());
                    break;
                case LocateState.FAILURE:
                    ((LocationViewHolder) holder).current.setText("定位失败");
                    break;
                default:
                    break;
            }
    ...
    public static class HotViewHolder extends BaseViewHolder {
        ...
        HotViewHolder(View itemView) {
            ...
            int space = itemView.getContext().getResources().getDimensionPixelSize(R.dimen.w_16_dip);
            mRecyclerView.addItemDecoration(new GridItemDecoration(GridListAdapter.SPAN_COUNT, space));
        }
    }
