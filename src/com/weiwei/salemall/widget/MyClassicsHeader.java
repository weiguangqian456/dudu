...
/**
 * @author Created by EDZ on 2018/12/13.
 *         Describe
 */

public class MyClassicsHeader extends InternalClassics<ClassicsHeader> implements RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public MyClassicsHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLastUpdateText.setTextColor(getResources().getColor(R.color.vs_blue));
        ...
        if (ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.ClassicsHeader_srlTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(com.scwang.smartrefresh.layout.R.styleable.ClassicsHeader_srlTextSizeTitle, DensityUtil
                    .dp2px(16)));
            mTitleText.setTextColor(getResources().getColor(R.color.vs_blue));
        } else {
        ...
        if (ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.ClassicsHeader_srlTextSizeTime)) {
            mLastUpdateText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(com.scwang.smartrefresh.layout.R.styleable.ClassicsHeader_srlTextSizeTime,
