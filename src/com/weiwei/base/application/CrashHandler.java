 ...
 * @Description: 全局处理未捕捉异常
 * @date 2014-4-8 下午2:23:22
 */
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        ...
        if (!handleException(ex) && mDefaultHandler != null) {
            ...
            try {
                ...
                LoggerUtils.info("killProcess error!");
            }
        }
    }
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            @Override
            public void run() {
                setStopAllAppDownload(VsApplication.getContext());
                Looper.prepare();
...
//                Log.e("an error occured when collect crash info", e);
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            //此次记录日志，后期可能会根据情况两者取其一。
            LoggerUtils.info(LoggerUtils.class, sb.toString());
            return fileName;
        } catch (Exception e) {
//            Log.e("an error occured while writing file...", e);
     ...
     * @throws:throws
     */
    private void setStopAllAppDownload(Context context) {
//        try {
//            AppDownloadService.getDownload(context).stopAllAppDownload();
//        } catch (DbException e) {
//            e.printStackTrace();
