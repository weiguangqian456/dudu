...
public class FileUtils {
    ...
    private static final String DEFAULT_STORE_PATH = "Android" + File.separator + "data" + File.separator + DfineAction.packagename;
//	private static final String DEFAULT_STORE_PATH = "LOCATION";
	 ...
	 * Application.
	 * 
	 * @return Specifies the path of the Application
	 */
    ...
    public static File createDirFile(String filePath) throws IOException {
        if (TextUtils.isEmpty(filePath)) {
            Log.d(TAG, "filePath is null.");
            return null;
        }
        ...
        if (file.mkdir()) {
            Log.i(TAG, "createDirFile(), make success");
        } else {
            Log.i(TAG, "createDirFile(), the file is exits");
        }
        return file;
    }
