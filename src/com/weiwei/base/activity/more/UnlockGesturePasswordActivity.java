...
import com.weiwei.lock.LockPatternView;
import com.weiwei.lock.LockPatternView.Cell;
import com.weiwei.netphone.VsMainActivity;

import java.util.List;
//import com.weiwei.base.im.ConnectionIm;
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (builder.getBoolean_pass()) {
                            ...
                            Intent intent = new Intent(UnlockGesturePasswordActivity.this, VsMainActivity.class);
...
//		if (!KcApplication.getInstance().getLockPatternUtils().savedPatternExists()) {
...
//		}
    ...
    protected LockPatternView.OnPatternListener mChooseNewLockPatternListener = new LockPatternView.OnPatternListener() {
        ...
        public void onPatternDetected(List<LockPatternView.Cell> pattern) {
            ...
            // 判断解锁是否成功
            if (new LockPatternUtils(getApplicationContext()).checkPattern(pattern)) {// 成功
...
//				startActivity(intent);
                ...
                intent.setClass(UnlockGesturePasswordActivity.this, VsMainActivity.class);
                startActivity(intent);
