...
import com.weiwei.lock.LockPatternView.DisplayMode;
...
//				false), 
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.kc_gesturepassword_create);
		// 初始化演示动画--绘制解锁图案
		...
		mFooterLeftButton.setVisibility(View.INVISIBLE);
...
//		KcApplication.getInstance().getLockPatternUtils().saveLockPattern(mChosenPattern);
		new LockPatternUtils(getApplicationContext()).saveLockPattern(mChosenPattern);
		showToast("密码设置成功");
