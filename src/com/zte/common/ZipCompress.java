...
public class ZipCompress {
    ...
    public static void zipFiles(File[] srcfile, File zipfile) {
        Log.i(TAG, "zipFiles(), target file is " + zipfile.getAbsolutePath());
        ...
        try {
            ...
            e.printStackTrace();
            Log.e(TAG, "zipFiles() error. Error Message is:" + e.getMessage());
        }
    }
    ...
    public static void unZipFolder(String zipFileString, String outPathString) {
        Log.i(TAG, "unZipFolder(), source file is " + zipFileString + ", out file path is " + outPathString);
        ...
        try {
            ...
            Log.e(TAG, "unZipFolder() error. Error Message is " + e.getMessage());
        } finally {
            if (null != inZip)
                try {
                    inZip.close();
