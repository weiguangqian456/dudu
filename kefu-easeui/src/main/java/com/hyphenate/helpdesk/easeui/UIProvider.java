...
//                    EventBusMsg event = new EventBusMsg();
//                    Map<String, Integer> map = new HashMap<>();
//                    map.put("NoReadMsg", msgs.size());
//                    event.setMap(map);
//                    EventBus.getDefault().post(event);
//                }
                for (Message message : msgs) {
                    Log.e("huanxin_msg", "---->" + message.body().toString());
                }

//                if (!EasyUtils.isAppRunningForeground(context)) {    //app后台
